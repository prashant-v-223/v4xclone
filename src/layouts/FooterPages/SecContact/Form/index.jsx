	            ...
	            <div className="row">
	              ...
	              <div className="col-12 col-md-6" data-aos="fade-up">
	                <div className="group wow fadeInUp" data-wow-delay="0.2s">
	                  ...
	                  <span className="bar" />
	                  <label>Name <span className="text-danger px-1">*</span></label>
	                </div>
	              </div>
	              <div className="col-12 col-md-6" data-aos="fade-up">
	                <div className="group wow fadeInUp" data-wow-delay="0.3s">
	                  ...
	                  <span className="highlight" />
	                  <span className="bar" />
	                  <label>Email <span className="text-danger px-1">*</span></label>
	                </div>
	              </div>
	              <div className="col-12" data-aos="fade-up">
	                <div className="group wow fadeInUp" data-wow-delay="0.4s">
	                  ...
	                  <span className="highlight" />
	                  <span className="bar" />
	                  <label>Subject <span className="text-danger px-1">*</span></label>
	                </div>
	              </div>
	              <div className="col-12" data-aos="fade-up">
	                <div className="group wow fadeInUp" data-wow-delay="0.5s">
	                  ...
	                  <span className="highlight" />
	                  <span className="bar" />
	                  <label>Message <span className="text-danger px-1">*</span></label>
	                </div>
	              </div>
