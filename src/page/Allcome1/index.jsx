  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record, index) => (
        <Tooltip
          placement="topLeft"
          title={record.username ? record.username : record.Usernameby}
        >
          {record.username ? record.username : record.Usernameby}
        </Tooltip>
      ),
    },
    {
          ...
          <div className="mainsection">
            <div className="row p-4">
              ...
              >
                ...
                <ExportToExcel apiData={Fillter} fileName={"AllIncome"} />
              </Col>
