...
function LavalincomeRepors() {
  const communityincome = useSelector((state) => state.communityincome);
  ...
  return (
    <>
      <Spin spinning={communityincome && !communityincome.isLoader}>
        <Navbar />
          ...
          <div className="mainsection">
            <div className="row p-4">
              ...
              >
                ...
                <ExportToExcel apiData={Fillter} fileName={"CommunityBuildingProgrameIncome"} />
              </Col>
              <div className="col-12 p-2 p-lg-3">
                <Table
                  columns={columns}
                  dataSource={Fillter}
                  title={() => "Community Building Programe Income"}
                  scroll={{ x: "1500px " }}
                  bordered={true}
                  pagination={{
                    defaultPageSize: 10,
...
export default LavalincomeRepors;
