...
// import { Wallatedata, getdappWallatedata, getdappWallatedata1 } from "../../Redux/WallatedatSlice";
...
//                       style={{ background: "#1868E2", position: "inherit" }}
//                       onClick={() => {
//                         navigator.clipboard.writeText(Profile[0]?.walletaddress);
...
//                   </div>
//                   <div className="d-flex h-50 h-md-100 flex-column justify-content-center">
//                     <h6 className="pt-3 text-center">Infinity.AI COIN CURRENT PRICE</h6>
//                     <h6 className="text-center">
//                       {StackingSlice.Wallatedata?.data?.Infinity.AItokenprice.toFixed(
//                         3
//                       )}
//                       $
//                     </h6>
