  ...
  return (
    <section className="features section-padding-100">
      <SectionHeading
        ...
        text="Infinity.AI Centralised Exchange is built with superfast trading matching engine, where users can trade their Infinity.AI Tokens in Spot, Limit, Market, Stop-Limit features."
      />
