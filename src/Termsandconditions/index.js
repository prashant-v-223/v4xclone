...
function Termsandconditions() {
  return (
    <div className="container">
      <h4 className="text-light pt-5 pb-3">V4X COIN TERMS & CONDITIONS.</h4>
      <p>
        The website V4X.ORG is operated by V4X COIN, Throughout the site, the
        terms “we”, “us” and “our” refer to V4X COIN, and/or V4X.ORG. V4X COIN,
      ...
      <p>
        By visiting our site and/ or purchasing V4X COIN from V4X.ORG, you
      ...
      <p>
        ...
        agree to hold V4X COIN, and its/their affiliates harmless against any
      ...
      <p>
        Your submission of personal information through the V4X COIN is governed
